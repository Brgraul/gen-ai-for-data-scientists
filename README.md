# AI Programming for Data Scientists

![Course Banner](./assets/banner.png)

Welcome, pioneers! Throughout this course, we aim to empower you with tools that will be an exponential amplifier to your skillset. Many of the workflows feel futuristic, magical, or even dystopian. However, trust the process and the results speak for themselves. 
...
### **Lecture 1**: Pushing VS Code's AI coding to its limits 
[![Foundations](https://img.shields.io/badge/Foundations-blue?style=flat-square)]()
...
### **Lecture 2**: Using GenAI to thoroughly test your code 
[![Testing](https://img.shields.io/badge/Testing-teal?style=flat-square)]()
...
### **Lecture 3**: Improving coding standards with GenAI 
[![Security, Performance](https://img.shields.io/badge/Security%2C%20Performance-red?style=flat-square)]()
...
### **Lecture 4**: Systems architecture with GenAI
[![Architecture](https://img.shields.io/badge/Architecture-purple?style=flat-square)]()
